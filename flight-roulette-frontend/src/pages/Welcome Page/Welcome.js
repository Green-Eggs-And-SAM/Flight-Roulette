...
function Welcome() {
    ...
    function playGsapTimeline() {
        // gsap.to(".welcome__title", { autoAlpha: 1, x: 0 });
        const title = document.querySelector(".welcome__title");
        gsap.from(title, { opacity: 0, x: -200, duration: 0.5 });
        const subtitle = document.querySelector(".welcome__subtitle");
        gsap.from(subtitle, { opacity: 0, x: -200, delay: 0.7, duration: 0.5 });
        const credits = document.querySelector(".credits");
        gsap.from(credits, { opacity: 0, delay: 2, duration: 0.5 });
        const footer = document.querySelector(".footer");
        gsap.from(footer, { opacity: 0, delay: 2, duration: 0.5 });
    }
